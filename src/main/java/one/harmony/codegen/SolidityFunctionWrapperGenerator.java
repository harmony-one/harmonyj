...
public class SolidityFunctionWrapperGenerator extends FunctionWrapperGenerator {
	...
	private SolidityFunctionWrapperGenerator(File binFile, File abiFile, File destinationDir, String basePackageName,
	...
	private void generate() throws IOException, ClassNotFoundException {
		...
		if (functionDefinitions.isEmpty()) {
			...
			new SolidityFunctionWrapper(useJavaNativeTypes).generateJavaFiles(contractName, binary, abi,
	...
	static class PicocliRunner implements Runnable {
		...
		public void run() {
			try {
				...
				new SolidityFunctionWrapperGenerator(binFile, abiFile, destinationFileDir, packageName, useJavaTypes)
						.generate();
			} catch (Exception e) {
				exitError(e);
			}
